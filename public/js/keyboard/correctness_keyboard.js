export default class CorrectnessKeyboard {

    constructor(lettersService) {
        this.keyboardContainerId = "correctness-keyboard-container";
    ...
    updateColors() {
        for (let letter in this.lettersElements) {
            let score = this.lettersService._getCorrectnessScore(letter)
            let hue = score * 240
